...
\begin{enumerate}
	\item The locus of $z$ which lies in the shaded region (excluding the boundaries) is best represented by \hfill{(2005S)}\\
...
\begin{enumerate}[label=(\alph*)]
	...
	\item $\pi$
\end{enumerate}
\item The value of $\sum_{k=1} ^{6} (\sin \frac{2\pi k}{7}-i\cos \frac{2\pi k}{7})$ is \hfill{(1987 - 2 Marks)}
\begin{enumerate}[label=(\alph*)]
