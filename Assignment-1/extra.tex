...
\item Tangent at a point $P_{1}$ {other than \brak{0, 0}} on the curve $y=x^{3}$ meets the curve again at $P_{2}$. The tangent at $P_{2}$ meets the curve again at $P_{1}$, and so on. Show that the abscissae of $P_{1}, P_{2}, P_{3} \dots P_{n}$, form a G.P. Also find the ratio. \sbrak{area(\Delta P_{1}P_{2}P_{3})}/\sbrak{area(\Delta P_{2}P_{3}P_{4})}
